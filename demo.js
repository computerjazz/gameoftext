...
var chambers = function(){
    ...
    {"dirk-catelyn":"A dark thought passes through your mind.  But no...","cloak-catelyn":"\"It's warm enough in here already, Ned.\"","onion-catelyn":"\"You know I despise the tast of onions.\"","potato-catelyn":"\"I'm not hungry, Ned\"","flower-catelyn":"test"}];
...
var jqconsole = $('#console').jqconsole('Testing this bullshit.\n', '> ');
var loop = function(){
  jqconsole.Prompt(true, function (input){
    input = input.split(" ")
    if (input[0] === "go"){
         var room = rooms[input[1]]();
    }
    loop();
  });
}
